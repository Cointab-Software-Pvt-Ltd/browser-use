...
class Controller(Generic[Context]):
    def __init__(
        ...
        @self.registry.action(
            'Called by the AI Agent to inform the developers if a new function is required for achieving the task',
            param_model=RequestAction)
        async def request_action(params: RequestAction, browser: BrowserContext):
            logger.info(params)
